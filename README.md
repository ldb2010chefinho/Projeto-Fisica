...
4. Clique em **Enviar** para calcular e visualizar os gráficos.
...
| Campo | Descrição |
|---|---|
| Espaço (s) | Posição final (m) |
| Espaço Inicial (s₀) | Posição inicial (m) |
| Velocidade (v) | Velocidade constante (m/s) |
...
| Espaço (s) | Posição final (m) |
| Espaço Inicial (s₀) | Posição inicial (m) |
| Velocidade Inicial (v₀) | Velocidade no instante t = 0 (m/s) |
| Aceleração (a) | Aceleração constante (m/s²) |
